...
class ProjectController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile('uri')) {
            ...
            $imagePath = Storage::disk('s3')->putFileAs('projects', $image, $fileName);
        }
        ...
        $project = Project::create([
            ...
            'uri' => $imagePath ?: 'https://www.hycproyectos.com/wp-content/uploads/2021/06/28_06_-%C2%BFPor-que-es-necesaria-la-interventoria-de-obras-civiles-en-los-proyectos_-970x485.jpg',
            ...
            if ($request->hasFile('uri')) {
                ...
                if ($previousImage && !Str::startsWith($previousImage, 'http')) {
                    if (Storage::disk('s3')->exists($previousImage)) {
                        ...
                        $localPath = public_path('images/projects/' . basename($previousImage));
